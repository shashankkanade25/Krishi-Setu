      ...
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.welcomeText}>
            ...
            <Text style={styles.welcomeDesc}>Join us in supporting local agriculture</Text>
          </View>
          ...
          {/* Create Account Button - matching web */}
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  // Brand logo
  brandLogo: { alignItems: 'center', marginBottom: 12 },
  ...
  // Switch row
  switchRow: { flexDirection: 'row', justifyContent: 'center', marginTop: 18, paddingBottom: 20 },
